    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="dashboard.php">
                ...
                <div class="sidebar-brand-text mx-3">FACID</div>
            </a>
            ...
            ?>
            <li class="nav-item">
                <a class="nav-link" href="https://www.moh.gov.my/index.php/pages/view/2573">
                    <i class="fas fa-newspaper"></i>
                    <span>Latest COVID19 Information</span></a>
            </li> 
            <li class="nav-item">
                <a class="nav-link" href="patient1.php">
