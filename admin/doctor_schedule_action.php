...
if(isset($_POST["action"]))
{
	if($_POST["action"] == 'fetch')
	{
		...
		{
			$order_column = array('doctor_table.doctor_name', 'doctor_schedule_table.doctor_schedule_date', 'doctor_schedule_table.doctor_schedule_day', 'doctor_schedule_table.doctor_schedule_start_time', 'doctor_schedule_table.doctor_schedule_end_time', 'doctor_schedule_table.working_time');
			$main_query = "
			...
			if(isset($_POST["search"]["value"]))
			{
				...
				$search_query .= 'OR doctor_schedule_table.working_time LIKE "%'.$_POST["search"]["value"].'%" ';
			}
		}
		else
		{
			$order_column = array('doctor_schedule_date', 'doctor_schedule_day', 'doctor_schedule_start_time', 'doctor_schedule_end_time', 'working_time');
			$main_query = "
			SELECT * FROM doctor_schedule_table 
			";
			...
			if(isset($_POST["search"]["value"]))
			{
				...
				$search_query .= 'OR working_time LIKE "%'.$_POST["search"]["value"].'%") ';
			}
		}
		...
		foreach($result as $row)
		{
			...
			$sub_array[] = $row["working_time"] . ' Hour';
	...
	if($_POST["action"] == 'Add')
	{
		...
		(doctor_id, doctor_schedule_date, doctor_schedule_day, doctor_schedule_start_time, doctor_schedule_end_time, working_time) 
		VALUES (:doctor_id, :doctor_schedule_date, :doctor_schedule_day, :doctor_schedule_start_time, :doctor_schedule_end_time, :working_time)
		";
